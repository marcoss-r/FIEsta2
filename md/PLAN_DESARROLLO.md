...
> de la carta y de los botones). Banco provisional inicial: las ~20 verdades
> y ~17 retos de muestra de `md/PLAN_VERDAD_O_RETO.md` §9. **Fase 3
> completa y ampliada**: 360 verdades y 360 retos (120 por nivel en cada
> banco, por encima del mínimo original de 200), con `verdades.json`/
